...
class GenerateTitleService {
  static Future<String> generateTitle(String text, String documentId) async {
    try {
      String generatedTitle = await sendTextToAI(text, documentId);
  ...
  static Future<String> sendTextToAI(String text, String documentId) async {
